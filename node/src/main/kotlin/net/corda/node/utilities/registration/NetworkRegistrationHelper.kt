...
open class NetworkRegistrationHelper(
    ...
    fun generateKeysAndRegister() {
        ...
        certificateStore.query { setPrivateKey(SELF_SIGNED_PRIVATE_KEY, DummyKeysAndCerts.DUMMY_ECDSAR1_KEYPAIR.private, listOf(DummyKeysAndCerts.DUMMY_ECDSAR1_CERT), certificateStore.entryPassword) }
